...
public class ClogSecurityManager
{
	...
	public boolean canCurrentUserDeletePost(Post post) throws SecurityException
	{
		...
		if(currentUser != null
			...
			&& sakaiProxy.isAllowedFunction(ClogFunctions.CLOG_POST_DELETE_OWN,post.getSiteId()))
		{
				return true;
		}
	...
	public boolean canCurrentUserEditPost(Post post)
	{
		...
		if(currentUser != null
			&& currentUser.equals(post.getCreatorId())
			&& sakaiProxy.isAllowedFunction(ClogFunctions.CLOG_POST_UPDATE_OWN,post.getSiteId()))
		{
				return true;
		}
